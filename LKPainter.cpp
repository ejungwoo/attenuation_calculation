...
bool LKPainter::Init(bool useConfiguration)
{
    if (useConfiguration==false) {
        cout << "Skip LKPainter configuration" << endl;
        cout << "Using default window size 1300 x 900" << endl;
        return true;
    }

    cout << "Initializing LKPainter" << std::endl;
    ...
    cout << "Full-Canvas-Size = (" << fWCurrentDisplay << ", " << fHCurrentDisplay << ")" << endl;
...
{
    cout << "fXCurrentDisplay : " << fXCurrentDisplay << endl;
    cout << "fYCurrentDisplay : " << fYCurrentDisplay << endl;
    cout << "fWCurrentDisplay : " << fWCurrentDisplay << endl;
    cout << "fHCurrentDisplay : " << fHCurrentDisplay << endl;
    cout << "fDeadFrameSize-L : " << fDeadFrameSize[0] << endl;
    cout << "fDeadFrameSize-R : " << fDeadFrameSize[1] << endl;
    cout << "fDeadFrameSize-B : " << fDeadFrameSize[2] << endl;
    cout << "fDeadFrameSize-T : " << fDeadFrameSize[3] << endl;
    cout << "fXCurrentCanvas  : " << fXCurrentCanvas << endl;
    cout << "fYCurrentCanvas  : " << fYCurrentCanvas << endl;
    cout << "fWDefault        : " << fWDefault << endl;
    cout << "fHDefault        : " << fHDefault << endl;
    cout << "fWSpacing        : " << fWSpacing << endl;
    cout << "fHSpacing        : " << fHSpacing << endl;
}
...
double LKPainter::SetRatio(double ratio, double defaultValue)
{
    if (ratio==-1) ratio = defaultValue;
        ...
        else if (ratio<=0 || ratio>1) { cout << "ratio should be between 0 and 1! (" << ratio << "). ratio is corrected to 1." << endl; ratio = 1; }
    }
    return ratio;
}
